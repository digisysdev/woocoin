...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Woocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"woocointools.com", "144.202.18.149"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"woocointools.com", "testnet-seed.woocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Woocoin is probably already running."), addrBind.ToString().c_str());
        else
